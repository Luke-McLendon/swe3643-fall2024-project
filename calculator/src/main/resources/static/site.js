class calculator
{
   ...
   requestStdDev ()
   {
      ...
      this.makeRequest ("POST", "/CalculateStdDev", data);
   }

   requestPopulationStdDev ()
   {
      let data = this.collectData();
      this.makeRequest("POST", "/CalculatePopulationStdDev", data);
   }

   requestMean ()
   {
      let data = this.collectData();
      this.makeRequest("POST", "/CalculateMean", data);
   }
   ...
   requestZScore ()
   {
      ...
      this.makeRequest("POST", "/CalculateZScore", json);
   }

   requestLinearRegression ()
   {
      let data = this.collectData();
      this.makeRequest("POST", "/CalculateLinearRegression", data);
   }

   requestYValue ()
   {
      let data = this.collectData();
      this.makeRequest("POST", "/CalculateYValue", data);
   }
